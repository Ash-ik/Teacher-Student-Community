...
<%--            <ul class="nav pull-right"  style="margin-top:-25px;">
 ...
 <div class="col-sm-6 col-md-3">
      ...
      <div class="caption">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TSC_database_connection_string %>" SelectCommand="SELECT [UserName], [pro_pic], [Status], [StatusTime], [likes] FROM [StatusUpdate] WHERE ([UserName] = @UserName)">
            <SelectParameters>
